...
🔬 **Research Interests**
`Biostatistics` • `Clinical Epidemiology` • `AI/ML in Healthcare` • `Federated Learning` • `Clinical Prediction` • `Evidence Synthesis`

🤝 **Collaboration**
Open to **international and interdisciplinary collaborations** in biostatistics, federated learning, AI/ML, clinical research, and healthcare data science.
